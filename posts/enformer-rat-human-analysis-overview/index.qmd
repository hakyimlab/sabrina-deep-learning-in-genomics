...
* Completed the hg38 predicted reference epigenome
* Some debugging on the low correlation between Enformer CAGE prediction on human reference genome and GTEx mean expression across all genes
    * [Plots comparing Enformer runs centered at TSS vs 57,344 bp intervals](https://sabrina-dl.hakyimlab.org/posts/2023-08-28-comparing-enformer-at-gene-tss-vs-reference-epigenome-vs-encode-experiments/)
    * [Correlation between Enformer CAGE:Brain predictions and various GTEx brain tissues](https://sabrina-dl.hakyimlab.org/posts/2023-08-30-comparing-predicted-reference-expression-to-various-GTEx-brain-tissues/)
...
* [Cisd2 personalized prediction for Br rats](https://sabrina-dl.hakyimlab.org/posts/2023-08-24-cisd2-correlation-across-rats/)
