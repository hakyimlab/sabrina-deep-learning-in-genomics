...
* [Plotted results for 868 genes selected for significant eQTLs and observed variation](https://sabrina-dl.hakyimlab.org/posts/2023-08-31-Br-personalized-prediction-on-more-genes/)
* [Started preparing VCF of HS founders for Enformer runs across all genes](https://sabrina-dl.hakyimlab.org/posts/2023-09-12-processing-HS-founder-rat-genotypes/)
* [Update correlation across genes plots](https://sabrina-dl.hakyimlab.org/posts/2023-09-13-all-correlation-across-genes-plots/)
...
Our progress so far is developing the pipeline. I added support for unphased VCFs, which cuts the number of Enformer runs in half by averaging the two haplotypes. I also added options to output mouse head predictions or both.
