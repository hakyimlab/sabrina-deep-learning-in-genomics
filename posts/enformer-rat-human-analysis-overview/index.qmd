...
I had to re-run some jobs for computing genotype probabilities, but the main progress has been in **organizing data into queryable databases**.

1. [Founder Rat Epigenomes](https://sabrina-dl.hakyimlab.org/posts/2023-12-07-concatenating-HS-reference-epigenomes)
    * `/eagle/AIHPC4Edu/sabrina/Br_predictions/HS_founder_epigenomes`, split by chromosome and model (human, mouse)

2. [Br haplotype probabilities](https://sabrina-dl.hakyimlab.org/posts/2023-12-06-qtl2-probabilites-to-sqlite-database)
