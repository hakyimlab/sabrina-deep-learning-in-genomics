...
plot(enet_Br_merged$cor, enet_Br_merged$spearman.r, main = "Cross-Individual Correlations from PrediXcan and Enformer's Human Head", type = "n", xlab = "PrediXcan", ylab = "Enformer")
