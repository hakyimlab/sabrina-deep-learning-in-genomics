...
p.add_argument("--data-dir", help="chromosome input folder generated in make_qtl2_inputs")
p.add_argument("--output-dir", help="folder to output probabilities saved as rds")
p.add_argument("--work-dir", default="tmp-qtl2-founder-haps", help="Name of directory to write qtl2 input files")
...
for i in range(n_batches):
    ...
    geno_df.to_csv(f'{args.work-dir}/geno.csv', index=True)
    covar_df.to_csv(f'{args.work-dir}/covar.csv', index=False)
    cmd = qtl_command(args.work-dir, f'{args.output-dir}/batch{i}_prob.rds', n_cores = 32)
